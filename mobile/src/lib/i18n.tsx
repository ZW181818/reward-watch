...
const en = {
  ...
  cases: 'Cases',
  casesSubtitle: 'Search public notices by country, state or province, status, and reward amount.',
  ...
  emptyHomeBody: 'Try a broader keyword or switch back to all supported notices.',
  ...
  home: 'Home',
  homeSubtitle: 'Official and reviewed public reward notices from supported jurisdictions',
  ...
  openPublisherSource: 'Open publisher source from {source}',
  ...
  publisherCaseInformation: 'Published notice information',
  publisherSafetyMessage: 'Do not approach any individual. Submit information directly to the published source.',
  publisherSource: 'Publisher source',
  publisherSourceWarning: 'Publisher safety notice',
  published: 'Published',
  race: 'Race',
...
export function getLocalizedCountry(country: 'All' | 'Canada' | 'China' | 'US', t: LanguageContextValue['t']) {
  if (country === 'All') return t('all');
  if (country === 'Canada') return t('canada');
  if (country === 'China') return t('china');
  return t('us');
}
